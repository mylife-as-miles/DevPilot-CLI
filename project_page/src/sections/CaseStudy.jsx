...
const BARS = {
  en: [
    ...
    { name: 'DevPilot', val: 67.67, win: true, gain: '+22.34' },
  ],
  zh: [
    { name: '初始', val: 45.33 },
    { name: 'Codex', val: 50.0 },
      ...
      <div className="container-wide">
        <Reveal>
          <div className="section-head">
            ...
            <p className="lead">
              {zh
                ? 'DevPilot 先后探索了仅靠 prompt 的信念状态修复、对抗式证伪、检索枚举与跨轨迹集成，最终合并了一个允许越界检索（override）的裁决器设计——把留出准确率远远推过了强大的单智能体基线。'
                : 'DevPilot explored prompt-only belief-state fixes, adversarial falsification, retrieval enumeration, and cross-trajectory ensembling before merging a judge-with-override design — lifting held-out accuracy well past strong single-agent baselines.'}
            </p>
          </div>
        </Reveal>
