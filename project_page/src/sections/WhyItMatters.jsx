...
const ITEMS = {
  en: [
    ...
    },
    {
      ...
      d: "DevPilot's best candidates arrive mid-to-late, conditioned on accumulated evidence. The same compute buys a less repetitive, more constrained search — not a longer gamble on stumbling into a result.",
    },
    {
      n: '03',
  ...
  zh: [
    ...
    },
    {
      n: '02',
      t: '每个实验都让下一个不再随机',
      d: 'DevPilot 最好的候选出现在中后期，以累积的证据为条件。同样的算力换来的是一次重复更少、约束更强的搜索——而不是一场靠运气碰中结果的更长的盲目尝试。',
    },
    {
      n: '03',
      t: '想法以证据为条件，而非猜测',
        ...
        <div className="split">
          <Reveal>
            <div>
              ...
              <p className="lead">
                {zh
                  ? '在 DevPilot 的轨迹中，被排除、被验证，或被证明存在边界条件的东西，都会成为下一个提议的先验。结果是一个让研究累积起来的过程——不是更多次尝试，而是重复更少、更具记忆性的搜索。'
                  : "Across DevPilot's traces, what gets ruled out, validated, or shown to have boundary conditions becomes a prior on the next proposal. The result is a process that makes research cumulative — not more attempts, but less repetitive, more memory-aware search."}
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
