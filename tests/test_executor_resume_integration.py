...
or via pytest. Maps the ``devpilot`` package onto ``src/`` so no install is needed.
"""
...
if "devpilot" not in sys.modules:
    _spec = importlib.util.spec_from_file_location(
        "devpilot", _ROOT / "src" / "__init__.py",
...
import devpilot.core.agent as agent_mod  # noqa: E402
import devpilot.core.tools as tools_mod  # noqa: E402
import devpilot.core.tools.executor_tool as exectool_mod  # noqa: E402
import devpilot.executor.prompts as prompts_mod  # noqa: E402
import devpilot.coordinator.tools.executor_run as er  # noqa: E402
from devpilot.coordinator.config import CoordinatorConfig  # noqa: E402
from devpilot.coordinator.idea_tree import IdeaTree, Node  # noqa: E402
