---
name: devpilot-agent-ideate
description: "Strict IDEATE-stage skill for DevPilot. Use immediately after TreeView(format=\"constraints\") when drafting Idea Tree nodes, enforcing the idea_drafting and first_principles_probe behavior, depth-aware idea levels, four-line TreeAddNode hypotheses, conflict checks, and self-filtering against shallow tweaks."
---
