...
description: "Public entrypoint for the DevPilot skill suite. Use when a user wants to run an DevPilot-style autonomous research or optimization workflow from a natural-language goal, including initial clarification of objective, target project, data, metric, evaluation, permissions, budget, run mode, and then automatic bootstrapping into devpilot-agent-orchestrator and phase skills."
---
