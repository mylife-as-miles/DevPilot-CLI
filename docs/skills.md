...
!!! question "Do I need to write one?"
    **No.** DevPilot ships with sensible default Skills that load automatically. Write your own
...
DevPilot ships a small set of Skills out of the box, loaded automatically:
...
1. Create the folder `.devpilot/skills/` inside your project and add a markdown file
   there, e.g. `<project>/.devpilot/skills/my_skill.md`. DevPilot discovers project
