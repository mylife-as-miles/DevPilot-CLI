...
Instead of one-shot attempts that forget what failed, DevPilot grows a **hypothesis tree**:
...
-   :material-rocket-launch: **Get running in minutes**
    ...
    `pip install devpilot-agent`, `devpilot setup`, then `devpilot`.

    [:octicons-arrow-right-24: Installation](installation.md)

-   :material-flask: **Run your first study**

    Point DevPilot at a benchmark and watch the Idea Tree grow.

    [:octicons-arrow-right-24: Quickstart](quickstart.md)

-   :material-sitemap: **Understand the method**

    The devpilot cycle, the Idea Tree, git isolation, and held-out discipline.
...
| Agent | Role |
| --- | --- |
| **Coordinator** | The research director. Maintains the Idea Tree, drives the search via the *devpilot cycle*, and dispatches experiments. |
