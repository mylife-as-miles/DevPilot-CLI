...
automated research through an devpilot-guided Idea Tree.
...
# ---------------------------------------------------------------------------
# Section 3: DevPilot Cycle Protocol
# ---------------------------------------------------------------------------
...
def _ideate_body_section(config: CoordinatorConfig) -> str:
    """Return the body of DevPilot Cycle Step 2 (IDEATE).
...
def _devpilot_cycle_protocol_section(config: CoordinatorConfig) -> str:
    # Plugin injections
    init_inject = ""
